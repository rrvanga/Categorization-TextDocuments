 ...
 *         University of Regina, June 2009. GNU General Public License v3 No
 *         reproduction in whole or part without maintaining this copyright
...
public class Apriori extends Observable {
	...
	private void calculateFrequentItemsets() {
		...
		for (int i = 0; i < itemsets.size(); i++) {
			...
			// Arrays.toString(candidates.get(i)) + "  is: "+ ((count[i] /
