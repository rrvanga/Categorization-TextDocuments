...
public class StopWordRemoval {
	HashSet<String> stopwords = new HashSet<>(Arrays.asList(new String[] { "a",
			...
			"due", "during", "each", "edit", "eg", "eight", "either", "eleven", "else",
			...
			"perhaps", "please", "put", "rather", "re", "same", "said", "see", "seem",
    ...
    StopWordRemoval( ArrayList<String> al)
    {
    	this.al = al;
    }
	public ArrayList<String> stopWordRemoval() {
		for (String i : al) {
			if (i != null && !i.equals("")) {
